...
Read more about [Global Data](/v3/api/configurations#global-data) in our docs, or look at the [commit](https://github.com/textwire/textwire/commit/f156f3fd2175f925652d462d75dc843a396de702).

### 3. Custom Functions for Object Type

In Textwire v2 you could define [custom functions](/v3/api/custom-functions) for all types except objects; in v3 you can now do that. This was added with [this commit](https://github.com/textwire/textwire/commit/a225ccacaf0fc9ca62365ebfe7e715de39b067af). Here is a simple example:
...
Now, in Textwire v3 you can use Go's embedded package to embed Textwire template files into a final, compiled binary. You can read about how to use this functionality in [our docs](/v3/api/template-embedding). But it looks something like this:
...
Use the [Global Data](/v3/api/configurations#global-data) to pass variables into all of your Textwire files.
