...
> You can read more detailed about built-in functions on the [Built-in Functions](/2.x/functions/) page.
...
> When you print a string, it will be automatically escaped. If you want to print a string without escaping it, you can use the a [raw()](/2.x/functions/#raw) function on strings. Example: `{{ "<h1>Test</h1>".raw() }}`
