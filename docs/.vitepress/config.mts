...
export default defineVersionedConfig(
    {
        ...
        sitemap: {
            hostname: 'https://textwire.github.io',
            ...
            search: {
                ...
                options: {
                    _render(src, env, md) {
                        ...
                        const shouldExclude = EXCLUDE_SEARCH_PREFIXES.some(path =>
                            env.relativePath.startsWith(path),
                        )

                        return shouldExclude ? '' : html
                    },
                },
            },
