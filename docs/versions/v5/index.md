...
The syntax is designed to be familiar and easy-to-learn, particularly for developers experienced with other template languages. Visit [Language Elements](/v5/language-elements/syntax) page to explore the full range of available statements and directives for your templates.

## How to Use It

You can use Textwire in three different ways:

1. [As a templating engine for web applications](/v5/api/template-usage)
2. [To embed dynamic content into strings](/v5/api/eval-string)
3. [To embed dynamic content into files](/v5/api/eval-file)
...
1. `loop` Object that is used inside loops. [Read more](/v5/language-elements/loops#loop-variables)
2. `global` Global object available in all Textwire files. [Read more](/v5/api/configurations#global-data)
