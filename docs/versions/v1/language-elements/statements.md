...
The second optional argument is a [Textwire object](/v1/language-elements/literals#object-literals) that you want to pass to the component. Here is another example of using a component with a second argument:
