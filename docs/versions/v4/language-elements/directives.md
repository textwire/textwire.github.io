...
The second optional argument is an [object](/v4/language-elements/literals#object) literal that will be passed to the component file. Here is another example of using a component with a second argument:
