...
Textwire provides two types of loops: [for loop](/v4/language-elements/directives#for) and [each loop](/v4/language-elements/directives#each). Both loops iterate over arrays with special syntax and additional features. This guide covers loop functionality and usage patterns.
