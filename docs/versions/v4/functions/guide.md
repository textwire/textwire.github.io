...
Learn about [error handling](/v4/api/error-handling) in Textwire when you call a function that doesn't exist, or when you pass incorrect arguments

## Unicode Support

Textwire's built-in functions fully support Unicode characters and strings. Whether you're working with emojis, accented characters, or non-Latin scripts, all functions work correctly. Learn more in the [Unicode](/v4/language-elements/unicode) section.
