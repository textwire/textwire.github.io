...
> When you print a string, it will be automatically escaped. If you want to print a string without escaping it, you can use the a [raw()](/v2/functions/str#raw) function on strings. Example: `{{ "<h1>Test</h1>".raw() }}`
