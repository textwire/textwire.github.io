...
- [String](#string) <code v-pre>{{ "Hello, World!" }}</code>
...
When you print a string, it will be automatically escaped. If you want to print a string without escaping it, you can use the a [raw()](/v2/functions/str#raw) function on strings. Example: <code v-pre>{{ "<h1>Test</h1>".raw() }}</code>
