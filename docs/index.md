...
features:
    ...
    - title: Security
      ...
      icon: 🔒
    - title: "Customization"
      details: "Define custom functions, components, layouts, and error pages with full control over template structure"
      icon: 🎨
    - title: "Error Handling"
      details: "Detailed error messages with line numbers and file names for efficient template debugging"
      icon: 🐛
    - title: "Editor Integration"
      details: "Neovim and VSCode extensions provide syntax highlighting and editor integration"
      icon: 🖋‍
    - title: "Documentation"
